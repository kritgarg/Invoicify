    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ alignItems: 'flex-end' }}>
          ...
          <Text style={styles.text}>#{invoice?.id.slice(-6).toUpperCase()}</Text>
        </View>
      </View>
      ...
      <View style={styles.detailsSection}>
        ...
        <View style={{ alignItems: 'flex-end' }}>
          <View style={{ flexDirection: 'row', marginBottom: 4 }}>
            ...
            <Text style={styles.text}>{invoice?.issueDate && new Date(invoice.issueDate).toLocaleDateString()}</Text>
          </View>
          <View style={{ flexDirection: 'row', marginBottom: 4 }}>
            <Text style={{ ...styles.text, color: '#6B7280', marginRight: 10 }}>Due Date:</Text>
            <Text style={styles.text}>{invoice?.dueDate && new Date(invoice.dueDate).toLocaleDateString()}</Text>
          </View>
        </View>
      </View>
      ...
      <View style={styles.table}>
        <View style={styles.tableHeader}>
          ...
          <Text style={[styles.colPrice, styles.colTextHead]}>Price</Text>
